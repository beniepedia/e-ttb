                ...
                <div className='m-4'>
                    <div className='flex gap-4'>
                        ...
                        <div className='flex-1'>
                            ...
                            {errors.customer_id && <div className="invalid-feedback -mb-3">
                                {errors.customer_id}
                            </div>}
                        </div>
                    </div>
                    ...
                    <div className='flex gap-3 my-2'>
                        <div className='w-1/3'>
                            ...
                            <Select name='category' handleChange={onHandleChange} >
                                {
                        ...
                        <div className='flex-1'>
                            ...
                            />
                            {errors.barang && <div className="invalid-feedback">
                                {errors.barang}
                            </div>}
                    ...
                    <div className='mt-10'>
                        <Button type='submit' className='btn-success btn-block shadow hover:bg-green-300' processing={processing}>SIMPAN</Button>
                    </div>
                </div>
            </form>
