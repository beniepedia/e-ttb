...
const ReceiptAdd = ({ customers }) => {
    ...
    function handleAdd() {
        setData({
            ...data,
            details: [...data.details, { type: "", category: "printer" }],
        });
    }
                        ...
                        <div className="form-control w-full pr-14">
                            ...
                            <div className="input-group">
                                <Select
                                    name="customer_id"
                                    className={
                                        errors.customer_id && "select-error"
                                    }
                                    handleChange={onHandleChange}
                                >
                            ...
                            <div className="flex gap-3 mb-2" key={i}>
                                ...
                                <div>
                                    {i > 0 ? (
                                        <button
                                            type="button"
                                            className="flex justify-center items-center hover:btn-error transition-all btn-circle"
                                            onClick={handleRemove}
                                        >
                                            <Icon.DashCircleFill className="text-xl text-red-700" />
                                        </button>
                                    ) : (
                                        <button
                                            type="button"
                                            className="flex justify-center items-center text-green-700 btn-circle hover:btn-success transition-all"
                                            onClick={handleAdd}
                                        >
                                            <Icon.PlusCircleFill className="text-xl" />
                                        </button>
                                    )}
                                </div>
                            </div>
