            ...
            <div className="flex gap-2 flex-col w-full md:w-1/3">
                <div className=" rounded-lg shadow overflow-hidden">
                    <img
                        src={qrcode}
                        alt={qrcode}
                        className="border-white bg-slate-100 border-8 w-full"
                    />
...
WhatsappIndex.layout = (page) => (
    <Layouts auth={page.props.auth} children={page} />
);
