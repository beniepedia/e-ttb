    ...
    <dialog id="customer_info_modal" className="modal modal-bottom sm:modal-middle" open>
      <div className="modal-box max-w-md">
        <div className="flex items-center mb-4">
          ...
          <h3 className="ml-3 text-xl font-bold text-gray-900">Informasi Pelanggan</h3>
        </div>
        ...
        <div className="py-4 space-y-4">
          ...
          <div className="form-control">
            <label className="text-sm text-gray-500 mb-1">No. Whatsapp</label>
            <div className="flex items-center bg-gray-50 rounded-lg px-4 py-3">
              <Icon.Telephone className="h-5 w-5 text-gray-400 mr-3" />
              <span className="font-medium">{receipt.customer?.whatsapp || '-'}</span>
            </div>
          </div>
          
          <div className="form-control">
            <label className="text-sm text-gray-500 mb-1">No. Telepon</label>
            <div className="flex items-center bg-gray-50 rounded-lg px-4 py-3">
          ...
          <div className="form-control">
            <label className="text-sm text-gray-500 mb-1">Alamat</label>
            <div className="flex items-start bg-gray-50 rounded-lg px-4 py-3">
              <Icon.House className="h-5 w-5 text-gray-400 mr-3 mt-1" />
